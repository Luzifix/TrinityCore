...
enum LoginDatabaseStatements : uint32
{
    ...
    */
    ...
    LOGIN_SEL_BNET_ACTIVITY,
    LOGIN_SEL_BNET_ACTIVITY_ALL,
    LOGIN_INS_BNET_ACTIVITY_HISTORY,
    LOGIN_DEL_BNET_ACTIVITY_HISTORY,
    LOGIN_INS_BNET_ACTIVITY,
    LOGIN_INS_BNET_ACTIVITY_PLAYTIME,
    LOGIN_UPD_BNET_ACTIVITY_PLAYTIME,
    LOGIN_SEL_BNET_ACTIVITY_AVG,

    LOGIN_INS_BPAY_PURCHASE,

    LOGIN_REP_BNET_HARDWARE_HISTORY,
    LOGIN_SEL_BNET_SIMILAR_HARDWARE_HISTORY_ENTRIES,

    LOGIN_REP_ENDORSEMENT_REQUEST,
    LOGIN_UPD_ENDORSEMENT_REQUEST_SELECTED_TYPE,
    LOGIN_INS_ENDORSEMENT,

    LOGIN_SEL_BNET_CONDITIONAL_APPEARANCE,
    LOGIN_REP_BNET_CONDITIONAL_APPEARANCE,

    LOGIN_DEL_BNET_ACCOUNT_BANNED,
    LOGIN_SEL_ACCOUNT_ID_BY_BNET_ACCOUNT,
    LOGIN_SEL_BNET_ACCOUNT_HARDWARE_BY_EMAIL,
    LOGIN_INS_HARDWARE_BANNED,
    LOGIN_DEL_EXPIRED_HARDWARE_BANS,
    LOGIN_DEL_HARDWARE_BANS,

    LOGIN_REP_BATTLENET_ACCOUNT_FURNITURE,
    LOGIN_REP_BATTLENET_ACCOUNT_FURNITURE_INVENTORY,
    LOGIN_DEL_BATTLENET_ACCOUNT_FURNITURE_INVENTORY,
