...
enum WorldDatabaseStatements : uint32
{
    ...
    */
    ...
    WORLD_INS_FURNITURE_CATALOG_ENTRY,
    WORLD_DEL_FURNITURE_CATALOG_CATEGORY_BY_FURNITURE_ID,
    WORLD_INS_FURNITURE_CATALOG_CATEGORY,
    WORLD_INS_FURNITURE_INVENTORY,
    WORLD_SEL_FURNITURE_CATALOG_CATEGORIZATION,
    WORLD_SEL_FURNITURE_CATALOG_CATEGORIZATION_BY_ID,
    WORLD_SEL_FURNITURE_CATALOG_CATEGORIZATION_BY_STATUS,
    WORLD_REP_FURNITURE_CATALOG_CATEGORIZATION,
    WORLD_UPD_FURNITURE_CATALOG_CATEGORIZATION_STATUS,
    WORLD_UPD_FURNITURE_CATALOG_CATEGORIZATION_REJECT_PENDING_REQUESTS_BY_FURNITURE_ID,
    WORLD_DEL_FURNITURE_CATALOG_CATEGORIZATION_BY_ID,

    WORLD_SEL_MORPH_BY_CATEGORY_ID,
    WORLD_SEL_MORPH_CATEGORY,

    WORLD_INS_ITEM_PRICE,
    WORLD_INS_ITEM_PRICE_CATEGORIZE_REQUEST,
    WORLD_DEL_ITEM_PRICE_CATEGORIZE_REQUEST_BY_DISPLAY_INFO_ID,
    WORLD_REP_ITEM_PRICE_CATEGORIZE_REQUEST_NOTIFIY,
    WORLD_DEL_ITEM_PRICE_CATEGORIZE_REQUEST_NOTIFIY_BY_DISPLAY_INFO_ID,
    WORLD_UPD_ITEM_PRICE_CATEGORIZE_REQUEST_SET_CATEGORIZED_BY_DISPLAY_INFO_ID,

    WORLD_SEL_GAMEOBJECT_COUNT_BY_HOUSING_AREA_ID,
    WORLD_SEL_GAMEOBJECT_VALUE_BY_HOUSING_AREA_ID,
    WORLD_SEL_GAMEOBJECT_BY_HOUSING_AREA_ID,

    WORLD_INS_CREATURE_ADDON_EMOTE,
    WORLD_UPD_CREATURE_ADDON_EMOTE,
    WORLD_SEL_GAME_EVENT_CREATURE_BY_GUID,
    WORLD_INS_GAME_EVENT_CREATURE,
    WORLD_UPD_GAME_EVENT_CREATURE,

    WORLD_SEL_FOLLOWER_SPAWNER_BY_CREATURE_ENTRY,
    WORLD_SEL_FOLLOWER_SPAWNER_CHILDS_BY_CREATURE_ENTRY,
    WORLD_REP_FOLLOWER_SPAWNER,
    WORLD_INS_FOLLOWER_SPAWNER_CHILDS,

    WORLD_INS_SIGN,
    WORLD_REP_SIGN_HISTROY,
    WORLD_DEL_SIGN,
