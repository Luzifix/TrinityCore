...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_SEL_MAIL,
    CHAR_SEL_MAIL_SENDER_LIST_UNREADED,
    ...
    CHAR_REP_HOUSING,
    CHAR_DEL_HOUSING,
    CHAR_REP_HOUSING_AREA,
    CHAR_DEL_HOUSING_AREA,
    CHAR_DEL_HOUSING_AREA_BY_HOUSING_ID,
    CHAR_INS_HOUSING_AREA_TRIGGER,
    CHAR_DEL_HOUSING_AREA_TRIGGER,
    CHAR_INS_HOUSING_AREA_PERMISSION,
    CHAR_DEL_HOUSING_AREA_PERMISSION,
    CHAR_SEL_HOUSING_BASEMENT,
    CHAR_REP_HOUSING_BASEMENT,
    CHAR_DEL_HOUSING_BASEMENT,
    CHAR_INS_HOUSING_TRANSFER_HISTORY,
    CHAR_SEL_HOUSING_TRANSFER_HISTORY_CHECK_LAST_MONTH_BY_HOUSE_ID,
    CHAR_SEL_HOUSING_TRANSFER_HISTORY_CHECK_LAST_MONTH_BY_BNET_ID,
    CHAR_INS_HOUSING_AREA_ADDON_COORDINATES,
    CHAR_SEL_HOUSING_NEXT_ID,
    CHAR_SEL_HOUSING_AREA_NEXT_ID,
    CHAR_SEL_HOUSING_HEARTHSTONE,
    CHAR_REP_HOUSING_HEARTHSTONE,
    CHAR_DEL_HOUSING_HEARTHSTONE,

    CHAR_SEL_CHARACTER_MODIFY,
    CHAR_INS_CHARACTER_MODIFY_SCALE,
    CHAR_INS_CHARACTER_MODIFY_SPEED,
    CHAR_INS_CHARACTER_MODIFY_MORPH,

    CHAR_SEL_GUILD_ACTIVITY_ALL,
    CHAR_INS_GUILD_ACTIVITY_HISTORY,
    CHAR_DEL_GUILD_ACTIVITY_HISTORY,
    CHAR_INS_GUILD_ACTIVITY_PLAYTIME,
    CHAR_UPD_GUILD_ACTIVITY_PLAYTIME,

    CHAR_REP_CHARACTER_MOUNT,
    CHAR_REP_CHARACTER_MOUNT_PERMISSION,
    CHAR_UPD_CHARACTER_MOUNT_POSITION_BY_GUID_AND_TEMPLATE_ID,
    CHAR_DEL_CHARACTER_MOUNT,

    CHAR_SEL_ITEM_SELLER_PERMISSION,
    CHAR_INS_ITEM_SELLER_HISTORY,

    CHAR_SEL_SUM_CHARACTERS,
