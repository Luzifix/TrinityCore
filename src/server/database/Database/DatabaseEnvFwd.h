...
class WebsiteDatabaseConnection;
...
using WebsiteDatabasePreparedStatement = PreparedStatement<WebsiteDatabaseConnection>;
...
using WebsiteDatabaseTransaction = SQLTransaction<WebsiteDatabaseConnection>;
...
using WebsiteDatabaseQueryHolder = SQLQueryHolder<WebsiteDatabaseConnection>;
