...
//                                        = 752, see LANG_PINFO_ACC_IP
    ...
    LANG_HOUSING_ERR_MULTIPLE_AT_SAME_TIME        = 50001,
    LANG_HOUSING_CREATE_START_OK                  = 50002,
    LANG_HOUSING_CREATE_ERR_NOT_STARTED           = 50003,
    LANG_HOUSING_CREATE_CANCEL_OK                 = 50004,
    LANG_HOUSING_CREATE_SAVE_ERR                  = 50005,
    LANG_HOUSING_CREATE_SAVE_OK                   = 50006,
    LANG_HOUSING_CREATE_TRIGGER_ADD_OK            = 50007,
    LANG_HOUSING_CREATE_TRIGGER_DEL_EMPTY         = 50008,
    LANG_HOUSING_CREATE_TRIGGER_DEL_OK            = 50009,
    LANG_HOUSING_CREATE_TRIGGER_CLEAR_OK          = 50010,
    LANG_HOUSING_CREATE_START_ERR_ALREADY_EXISTS  = 50011,
    LANG_HOUSING_MODIFY_START_OK                  = 50012,
    LANG_HOUSING_MODIFY_ERR_ID                    = 50013,
    LANG_HOUSING_SET_OK                           = 50014,
    LANG_HOUSING_DELETE_OK                        = 50015,
    LANG_HOUSING_BUILDING_ERR_NO_OBJECT_IN_RANGE  = 50016,
    LANG_HOUSING_BUILDING_ERR_OBJECT_NOT_CATEGORIZED = 50017,
    LANG_HOUSING_FURNITURE_ERR_SPAWN              = 50018,
    LANG_HOUSING_FURNITURE_ERR_NOT_ENOUGH_ITEMS_TO_CLONE = 50019,
    LANG_HOUSING_MOTD                             = 50020,
    LANG_HOUSING_NO_BUILD_PERMISSION              = 50021,
    LANG_HOUSING_CANT_SPAWN_OR_MOVE_OBJECT_OUT_OF_HOUSE = 50022,
    LANG_HOUSING_FURNITURE_NOT_FOUND              = 50023,
    LANG_HOUSING_ERR_NOT_ENOUGH_ITEMS             = 50024,
    LANG_HOUSING_ERR_GAMEMASTER_MODE_IN_HOUSING_NOT_ALLOWED = 50025,
    LANG_HOUSING_ERR_FACILITY_LIMIT_REACHED       = 50026,
    LANG_HOUSING_INFO_NOT_FOUND                   = 50027,
    LANG_HOUSING_INFO                             = 50028,
    LANG_HOUSING_DOOR_ERR_NOT_IN_HOUSING_AREA     = 50029,
    LANG_HOUSING_DOOR_ERR_PERMISSION_DENIED       = 50030,
    LANG_HOUSING_ID                               = 50031,
    LANG_HOUSING_PHASE_ID                         = 50032,
    LANG_HOUSING_ERR_TOO_FAR_FROM_LADDER          = 50033,
    LANG_HOUSING_ERR_ID_NOT_FOUND                 = 50034,
    LANG_HOUSING_RESET_OK                         = 50035,
    LANG_HOUSING_ERR_TRANSFER_OWNERSHIP_TARGET_OFFLINE = 50036,
    LANG_HOUSING_ERR_TRANSFER_OWNERSHIP_ALREADY_OWNER = 50037,
    LANG_HOUSING_ERR_TRANSFER_OWNERSHIP_NOT_IN_GROUP = 50038,
    LANG_HOUSING_ERR_TRANSFER_OWNERSHIP_TO_MANY_HOUSES_MESSAGE_FOR_OWNER = 50039,
    LANG_HOUSING_ERR_TRANSFER_OWNERSHIP_TO_MANY_HOUSES_MESSAGE_FOR_TARGET = 50040,
    LANG_HOUSING_ERR_TRANSFER_OWNERSHIP_TO_MANY_LARGE_HOUSES_MESSAGE_FOR_OWNER = 50041,
    LANG_HOUSING_ERR_TRANSFER_OWNERSHIP_TO_MANY_LARGE_HOUSES_MESSAGE_FOR_TARGET = 50042,
    LANG_HOUSING_ERR_TRANSFER_OWNERSHIP_HOUSE_HAS_ALREADY_BEEN_TRANSFERD_WITHIN_A_MONTH_FOR_OWNER = 50043,
    LANG_HOUSING_ERR_TRANSFER_OWNERSHIP_HOUSE_HAS_ALREADY_BEEN_TRANSFERD_WITHIN_A_MONTH_FOR_TARGET = 50044,
    LANG_HOUSING_ERR_TRANSFER_OWNERSHIP_OWNER_HAS_ALREADY_TRANSFERD_TWO_HOUSES_WITHIN_A_MONTH_FOR_OWNER = 50045,
    LANG_HOUSING_ERR_TRANSFER_OWNERSHIP_OWNER_HAS_ALREADY_TRANSFERD_TWO_HOUSES_WITHIN_A_MONTH_FOR_TARGET = 50046,
    LANG_HOUSING_ERR_TRANSFER_OWNERSHIP_TARGET_HAS_ALREADY_TRANSFERD_TWO_HOUSES_WITHIN_A_MONTH_FOR_OWNER = 50047,
    LANG_HOUSING_ERR_TRANSFER_OWNERSHIP_TARGET_HAS_ALREADY_TRANSFERD_TWO_HOUSES_WITHIN_A_MONTH_FOR_TARGET = 50048,
    LANG_HOUSING_LOG_TRANSFER_OWNERSHIP           = 50049,
    LANG_HOUSING_TYPE_SMALL_HOUSE                 = 50050,
    LANG_HOUSING_TYPE_LARGE_HOUSE                 = 50051,
    LANG_HOUSING_TYPE_NOBLE_HOUSE                 = 50052,
    LANG_HOUSING_TYPE_SHOP_OR_GUILD               = 50053,
    LANG_HOUSING_AREA_CREATE_ERR_NOT_STARTED      = 50054,
    LANG_HOUSING_AREA_ERR_MULTIPLE_AT_SAME_TIME   = 50055,
    LANG_HOUSING_AREA_ERR_ID_ALREADY_EXISTS       = 50056,
    LANG_HOUSING_AREA_ERR_NO_HOUSING_FOUND        = 50057,
    LANG_HOUSING_AREA_SAVED                       = 50058,
    LANG_HOUSING_AREA_CREATE_START_OK             = 50059,
    LANG_HOUSING_AREA_ERR_ID                      = 50060,
    LANG_HOUSING_AREA_ERR_HOUSING_AREA_IS_NOT_PART_OF_HOUSE = 50061,
    LANG_HOUSING_AREA_MODIFY_START_OK             = 50062,
    LANG_HOUSING_HEARTHSTONE_ERR_NOT_SET          = 50064,
    LANG_HOUSING_HEARTHSTONE_ERR_NO_HOUSING_AREA  = 50065,
    LANG_HOUSING_HEARTHSTONE_ERR_NO_ACCESS_PERMISSION = 50066,
    LANG_HOUSING_HEARTHSTONE_SET_SUCCESS          = 50067,
    LANG_HOUSING_LOG_TRANSFER_OWNERSHIP_AUTOMATIC = 50068,
    LANG_HOUSING_BUILDING_ERR_TO_MANY_OBJECTS     = 50069,

    LANG_ACTIVITY_MAIL_SUBJECT                    = 50100,
    LANG_ACTIVITY_MAIL_TEXT_REACHED_ACTIVITY      = 50101,
    LANG_ACTIVITY_MAIL_TEXT_NOT_REACHED_ACTIVITY  = 50102,
    LANG_ITEM_PRICE_LIST_NO_ENTRY                 = 50103,
    LANG_ITEM_PRICE_LIST_ENTRY                    = 50104,
    LANG_ITEM_PRICE_SET_ITEM_NOT_FOUND            = 50105,
    LANG_ITEM_PRICE_SET_CATEGORY_NOT_FOUND        = 50106,
    LANG_ITEM_PRICE_SET_CATEGORY_SUCCESS          = 50107,
    LANG_ACTIVITY_MAIL_TEXT_INACTIVITY_LIMIT_REACHED_AND_REMOVE_HOUSE = 50108,
    LANG_ACTIVITY_MAIL_TEXT_INACTIVITY_LIMIT_REACHED = 50109,
    LANG_ACTIVITY_LOG_SUMMARY                     = 50110,
    LANG_ITEM_PRICE_SET_DISCORD_LOG               = 50111,

    LANG_CHARACTER_MODIFY_OOC_COOLDOWN            = 50200,
    LANG_CHARACTER_MODIFY_OOC_DISABLED            = 50201,

    LANG_MOUNT_SYSTEM_ERR_NO_SEAT_AVAILABLE       = 50300,
    LANG_MOUNT_SYSTEM_ERR_NOT_IN_SAME_GROUP       = 50301,
    LANG_MOUNT_SYSTEM_STAT_MOOD_HAPPY             = 50302,
    LANG_MOUNT_SYSTEM_STAT_MOOD_ENERGETIC         = 50303,
    LANG_MOUNT_SYSTEM_STAT_MOOD_NORMAL            = 50304,
    LANG_MOUNT_SYSTEM_STAT_MOOD_UNDERWHELMED      = 50305,
    LANG_MOUNT_SYSTEM_STAT_MOOD_NEGLECTED         = 50306,
    LANG_MOUNT_SYSTEM_STAT_DIRTINESS_CLEAN        = 50307,
    LANG_MOUNT_SYSTEM_STAT_DIRTINESS_LITTLE_DIRTY = 50308,
    LANG_MOUNT_SYSTEM_STAT_DIRTINESS_DIRTY        = 50309,
    LANG_MOUNT_SYSTEM_STAT_DIRTINESS_NEGLECTED    = 50310,
    LANG_MOUNT_SYSTEM_PERMISSION_ADD_OK           = 50311,
    LANG_MOUNT_SYSTEM_PERMISSION_ERR_NOT_FOUND    = 50312,
    LANG_MOUNT_SYSTEM_PERMISSION_REMOVE_OK        = 50313,
    LANG_MOUNT_SYSTEM_ERR_INVALID_NAME            = 50314,
    LANG_MOUNT_SYSTEM_ERR_EMPTY_FUEL_OR_CONDITION = 50315,
    LANG_MOUNT_SYSTEM_ERR_NO_OWNER                = 50316,
    LANG_MOUNT_SYSTEM_ERR_NO_PERMISSION           = 50317,
    LANG_MOUNT_SYSTEM_EMOTE_EJECT_PLAYER          = 50318,
    LANG_MOUNT_SYSTEM_EMOTE_DIRTY                 = 50319,
    LANG_MOUNT_SYSTEM_EMOTE_SHIT                  = 50320,
    LANG_MOUNT_SYSTEM_ERR_NOT_ENOUGH_MONEY        = 50321,
    LANG_MOUNT_SYSTEM_ERR_PORT_TO_ME_WRONG_MAP    = 50322,
    LANG_MOUNT_SYSTEM_ERR_PORT_TO_ME_INDOOR       = 50323,
    LANG_MOUNT_SYSTEM_ERR_HAS_PASSANGER           = 50324,

    LANG_SOCIAL_SYSTEM_CHAT_RANGE_CHANGED         = 50400,
    LANG_SOCIAL_SYSTEM_ENDORSEMENTS_SUBMIT_SUCCESS = 50401,
    LANG_SOCIAL_SYSTEM_ENDORSEMENTS_SUBMIT_SKIP   = 50402,
    LANG_SOCIAL_SYSTEM_ENDORSEMENTS_SUBMIT_ERROR  = 50403,
    LANG_SOCIAL_SYSTEM_ENDORSEMENTS_MAIL_SUBJECT  = 50404,
    LANG_SOCIAL_SYSTEM_ENDORSEMENTS_MAIL_BODY     = 50405,

    LANG_MOUNTSYSTEM_CREATE_ERR_ID_NOT_FOUND      = 50500,
    LANG_MOUNTSYSTEM_CREATE_ERR_MOUNT_TEMPLATE_NOT_FOUND = 50501,
    LANG_MOUNTSYSTEM_CREATE_ERR_PLAYER_NOT_IN_WORLD = 50501,
    LANG_MOUNTSYSTEM_CREATE_OK                    = 50502,
    LANG_MOUNTSYSTEM_INFO_ERR_INVALID_TARGET      = 50503,
    LANG_MOUNTSYSTEM_INFO_OK                      = 50504,

    LANG_FOLLOWER_GOSSIP_RESET_CURRENT_GUILD      = 50600,
    LANG_FOLLOWER_GOSSIP_REMOVE_OPTION            = 50601,
    LANG_FOLLOWER_GOSSIP_REMOVE_OPTION_POPUP      = 50602,
    LANG_FOLLOWER_ERROR_CANT_FIND_NPC             = 50603,
    LANG_FOLLOWER_ERROR_FOLLOWER_LIMIT_REACHED    = 50604,
    LANG_FOLLOWER_SUCCESS_FOLLOWER_ADDED          = 50605,
    LANG_FOLLOWER_SUCCESS_GUILD_SET               = 50606,
    LANG_FOLLOWER_ERROR_GUILD_NOT_FOUND           = 50607,
    LANG_FOLLOWER_SUCCESS_FOLLOWER_DELETED        = 50608,
    LANG_FOLLOWER_SUCCESS_GUILD_RESET             = 50609,
    LANG_FOLLOWER_ERROR_TO_FAR_AWAY               = 50610,

    LANG_ITEM_SELLER_NO_PERMISSION                = 50700,
    LANG_ITEM_SELLER_NOT_SELLABLE                 = 50701,
    LANG_ITEM_SELLER_BUY_PRICE_AND_ITEM_LINK      = 50702,
    ...
    LANG_AUCTIONHOUSE_ERR_NOT_CATEGORIZED_ITEM    = 50900,
