...
#define _TRINITY_CORE_CONFIG_DIST "worldserver.conf.dist"
    ...
    #define _TRINITY_CORE_CONFIG  "worldserver.conf"
        ...
        #define _TRINITY_CORE_CONFIG_DIR "worldserver.win.conf.d"
    #else
        #define _TRINITY_CORE_CONFIG_DIR "worldserver.unix.conf.d"
    #endif
#endif
...
variables_map GetConsoleArguments(int argc, char** argv, fs::path& configFile, fs::path& configDir, [[maybe_unused]] std::string& winServiceAction)
{
    ...
    all.add_options()
        ...
        ("config,c", value<fs::path>(&configFile)->default_value(fs::absolute(_TRINITY_CORE_CONFIG_DIST)),
